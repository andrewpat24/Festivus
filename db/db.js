...
// sequelize model:generate --name festivals --attributes name:string,show_url:string,full_location:string,city:string,state_region:string,lat_long:string,date_span:string,bio:string,logo:string,genre:string,twitter_url:string,insta_url:string,facebook_url:string,view_count:int,follower_count:int
